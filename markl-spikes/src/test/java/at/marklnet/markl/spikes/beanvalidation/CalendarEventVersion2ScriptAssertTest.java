...
/**
 * Junit Test testet @ScriptAssert ClassLevel Constraint.
 * 
 * @author Markus Markl
 */
public class CalendarEventVersion2ScriptAssertTest {
    ...
    /** instance to test */
    private CalendarEventVersion2 instance;
    ...
    public void calendarEventIsValidAsEndDateIsAfterStartDate() {
        instance = new CalendarEventVersion2("Team meeting", startDate, endDate);
        assertTrue(validator.validate(instance).isEmpty());
    }

    @Test
    public void calendarEventIsInvalidAsEndDateIsBeforeStartDate() {
        instance = new CalendarEventVersion2("Team meeting", endDate, startDate);

        Set<ConstraintViolation<CalendarEventVersion2>> constraintViolations = validator.validate(instance);
